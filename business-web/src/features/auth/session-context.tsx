...
const ACCESS_TOKEN_KEY = "say-hi-chai-business-access-token";
const REFRESH_TOKEN_KEY = "say-hi-chai-business-refresh-token";
...
// keep failing until the page was manually reloaded).
  ...
  useEffect(() => {
    ...
    const interval = setInterval(async () => {
      ...
      try {
        ...
        // out; the next action the user takes will send them to /login.
        setUser(null);
        setAccessToken(null);
        setStatus("anonymous");
        clearStoredTokens();
